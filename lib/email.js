...
// Logo URL for emails
const LOGO_URL = process.env.NEXT_PUBLIC_BASE_URL ? `${process.env.NEXT_PUBLIC_BASE_URL}/logo.png` : 'https://easy-book-haul.preview.emergentagent.com/logo.png';
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: #f9f9f9; padding: 30px; border: 1px solid #ddd; border-top: none;">
    ...
    <div style="background: #d4edda; border: 2px dashed #28a745; border-radius: 8px; padding: 20px; margin: 20px 0; text-align: center;">
      <h4 style="margin: 0 0 10px 0; color: #155724;">🎁 Thank You Gift - 10% OFF Your Next Booking!</h4>
      <p style="margin: 0 0 15px 0; color: #155724;">Use this code on your next booking:</p>
      <div style="background: white; border: 2px solid #28a745; border-radius: 8px; padding: 15px; display: inline-block;">
        <span style="font-family: monospace; font-size: 28px; font-weight: bold; color: #155724; letter-spacing: 3px;">REPEAT10</span>
      </div>
      <p style="margin: 15px 0 0 0; color: #155724; font-size: 14px;">
        Share with friends & family - they can use it too!
      </p>
    </div>
...
🎁 THANK YOU GIFT - 10% OFF YOUR NEXT BOOKING!
Use code: REPEAT10
Share with friends & family - they can use it too!
