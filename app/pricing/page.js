    ...
    <div className="min-h-screen bg-white">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <div className="px-4 py-4 space-y-3">
              ...
              <Link href="/pricing" className="block text-orange-500 font-medium py-2">Pricing</Link>
      ...
      <section className="bg-gradient-to-br from-orange-500 to-orange-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-orange-100">No hidden fees. Know exactly what you're paying.</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <Card className="border-2 border-orange-500">
              ...
              <CardContent className="p-6">
                ...
                <Link href="/book">
                  <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white" size="lg">Book Now</Button>
                </Link>
              </CardContent>
            </Card>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-3xl font-bold text-orange-500">${pricing?.extraHourFee || 35}<span className="text-sm text-gray-500">/hour</span></p>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-3xl font-bold text-orange-500">${pricing?.overweightFee || 50}+</p>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-3xl font-bold text-orange-500">${pricing?.travelFee || 25}+</p>
